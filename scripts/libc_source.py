...
SELECTORS = {
    ...
    "unix/linux_like/linux/arch/generic/mod.rs": 'target_os = "linux"',
    "unix/linux_like/linux/arch/mips/mod.rs": 'all(target_os = "linux", any(target_arch = "mips", target_arch = "mips64"))',
    "unix/linux_like/linux/arch/powerpc/mod.rs": 'all(target_os = "linux", any(target_arch = "powerpc", target_arch = "powerpc64"))',
    "unix/linux_like/linux/arch/sparc/mod.rs": 'all(target_os = "linux", any(target_arch = "sparc", target_arch = "sparc64"))',
